...
/**
 * Groups together all operations related to tickets booking. Created by
 * maksym_govorischev.
 */
public interface BookingFacade {
	...
	/**
	 * Get list of users by matching name. Name is matched using 'contains'
	 * approach. In case nothing was found, empty list is returned.
	 * 
